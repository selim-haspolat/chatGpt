  ...
  return (
    <>
      {allQuestionsAndAnswers.length === 0 && (
        <div className="text-xl text-indigo-500 flex flex-col md:flex-row gap-3 justify-center md:items-center text-center px-5">
          <div
            onClick={(e) => handleClick(e.target.innerText)}
            className="bg-white/70 hover:bg-white transition-colors px-2 py-1 rounded cursor-pointer"
          >
            Write me a poem
          </div>
          <div
